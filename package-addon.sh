...
#
# Output: ../DynamicMovementSpeed-<version>.zip   (sibling of this repo, in the
#         shared addons working dir).
#
# The zip contains a single top-level folder `DynamicMovementSpeed/` so users on
...
rsync -a \
  ...
  "$SRC/" "$STAGE/DynamicMovementSpeed/"
