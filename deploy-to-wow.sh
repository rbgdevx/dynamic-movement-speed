...
#
# What it does:
#   1. Bumps the trailing version segment in DynamicMovementSpeed.toc
#      (1.3.N → 1.3.(N+1)). Done first so a malformed .toc fails
#      fast before anything destructive happens to the live install.
#   2. Wipes /Applications/World of Warcraft/_retail_/Interface/AddOns/DynamicMovementSpeed
...
DEST="/Applications/World of Warcraft/_retail_/Interface/AddOns/DynamicMovementSpeed"
